...
export interface ApiHullMaterialHullMaterial extends Schema.CollectionType {
  collectionName: 'hull_materials';
  info: {
    singularName: 'hull-material';
    pluralName: 'hull-materials';
    displayName: 'HullMaterial';
  };
  options: {
...
export interface ApiManufacturerLogoManufacturerLogo
  extends Schema.CollectionType {
  collectionName: 'manufacturer_logos';
  info: {
    singularName: 'manufacturer-logo';
    pluralName: 'manufacturer-logos';
    displayName: 'ManufacturerLogo';
  };
  options: {
    draftAndPublish: true;
  };
...
export interface ApiModelModel extends Schema.CollectionType {
  ...
  attributes: {
    name: Attribute.String;
    lengthMeter: Attribute.Decimal;
    beamMeter: Attribute.Decimal;
    draftMeter: Attribute.Decimal;
    manufacturer: Attribute.Relation<
      'api::model.model',
      'manyToOne',
      'api::manufacturer.manufacturer'
    >;
    type: Attribute.Relation<'api::model.model', 'manyToOne', 'api::type.type'>;
    hull_material: Attribute.Relation<
      'api::model.model',
      'oneToOne',
      'api::hull-material.hull-material'
    >;
...
declare module '@strapi/types' {
  export module Shared {
    export interface ContentTypes {
      ...
      'api::hull-material.hull-material': ApiHullMaterialHullMaterial;
      'api::manufacturer.manufacturer': ApiManufacturerManufacturer;
      'api::manufacturer-logo.manufacturer-logo': ApiManufacturerLogoManufacturerLogo;
